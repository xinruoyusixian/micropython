...
"""MicroPython library for the INA219 sensor电压模块.
...
if __name__=='__main__':
  def read_VI():
      try:
          solar_voltage = str(ina.voltage())
          solar_current = str(ina.current())
          print("BusVolt:" + solar_voltage + "V:Current:" + solar_current + "mA:#")
      except:
  ...
  ina = INA219(SHUNT_OHMS, i2c, INA219A_ADDR)

  try:
      print("INA219:0x40: Configuring ina...")
      ina.configure_32v_2a()
  except:
      print("INA219:0x40: ina Missing...")  
